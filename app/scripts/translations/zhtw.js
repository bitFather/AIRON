...
X_HelpfulLinks_4                :  'Migrating to/from Airon',
...
/* Onboarding */
ONBOARD_welcome_title           :  '歡迎來到 Airon.com',
...
ONBOARD_welcome_content__4      :  '什麼是Airon.io? ',
ONBOARD_welcome_content__5      :  'Airon 是一個免費、開源、運行於用戶端的介面。',
...
ONBOARD_bank_title              :  'Airon 不是一間銀行',
...
ONBOARD_interface_title         :  'Airon 是一個介面',
ONBOARD_interface_content__1    :  '當你在 Airon 建立一個帳戶，你是在產生一串密碼數列：你的私鑰和你的公鑰 (地址)。',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from Airon, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on Airon.com or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
...
ONBOARD_whymew_title            :  'If Airon can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'If you are scared but want to use Airon.io, [get a hardware wallet](https://airon.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like Airon, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
ONBOARD_secure_1_content__2     :  'Install [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) or [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) or [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) or the [Airon Chrome Extension](https://chrome.google.com/webstore/detail/airon-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) to block malicious websites.',
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://www.airon.io`.',
ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `AIRON>` in green.',
...
ONBOARD_secure_3_content__6     :  '[Even more Security Tips!](https://airon.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
NAV_TxStatus                : '交易狀態',
tx_Details                  : '交易細節',
tx_Summary                  : '當乙太網路流量大時(例如有ICO進行中)，你的交易可能需要等待數小時甚至數天。 此工具將讓你 "取消" 或替換等待中的交易。 ** 這通常是不被允許的。 請不要過度依賴此工具，因為這些操作只有在交易池滿載時有用. [請閱讀關於此工具的說明。](https://airon.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',
tx_notFound                 : '查無交易',
tx_notFound_1               : '無法在你所連接的節點之交易池找到這筆交易。',
tx_notFound_2               : '如果你才剛送出交易，請等待 15 秒鐘後再按下 "檢查交易狀態" 按鈕。 ',
tx_notFound_3               : '這筆交易可能仍在在其他節點的交易池中等待被確認。',
tx_notFound_4               : '請用右上角的下拉式選單來選取其他 ETH 節點 (例如： `ETH (Etherscan.io)` 、 `ETH (Infura.io)` 或 `ETH (Airon)`) 並再檢查一次。',
...
tx_FoundOnChain_3           : '**如果你沒有看到任何錯誤，你的交易已被成功送出。** 你的乙太幣或代幣已經在目的地錢包。如果你沒有看到你的乙太幣或代幣出現在目的地錢包 / 交易所帳戶，而且你已經等待超過24小時，[請連絡該服務提供者](https://airon.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). 給他們你的交易紀錄 *連結* ，並且友善地請他們處裡你遇到的問題。',
...
GEN_Help_12                 : '用它在 Airon (或Mist、Geth、Parity和其他錢包) 來解鎖你的錢包 ',
...
sidebar_donation            : 'Airon是注重你的隱私和安全的免費、開源服務。如果有更多捐贈，我們就能花更多時間開發新功能、聽取你的建議並且滿足你的需要。我們只是兩個想要改變世界的人。幫助我們？ ',
sidebar_donate              : '捐贈 ',
sidebar_thanks              : '謝謝你!!! ',
...
ADD_Ledger_0a               : 'Please use Airon on a secure (SSL / HTTPS) connection to connect. ',
...
ADD_Ledger_0b               : '以 [Chrome](https://www.google.com/chrome/browser/desktop/) 或 [Opera](https://www.opera.com/) 瀏覽器重新開啟Airon',
...
ADD_DigitalBitbox_0a        : 'Re-open Airon on a secure (SSL) connection ',
ADD_DigitalBitbox_0b        : '以 [Chrome](https://www.google.com/chrome/browser/desktop/) 或 [Opera](https://www.opera.com/) 瀏覽器重新開啟Airon',
...
MYWAL_Content_3             : '如果你在未來還想在Airon擴充功能上操作此錢包，你必須使用私鑰或JSON檔和密碼來重新新增它。 ',
...
NODE_Warning                : '你的節點必須使用HTTPS安全連線的方式才能夠由 Airon.com 連接到它。 你可以下載 [Airon repo](https://github.com/kvhnuke/etherwallet/releases/latest) 並建立起一個你的節點來連接至其他的節點。或著從 [LetsEncrypt](https://letsencrypt.org/) 獲取免費的SSL憑證',
NODE_Name                   : '節點名稱',
NODE_Port                   : '節點連線的端口號碼',
...
ERROR_28                    : '**以後你會需要密碼和Keystore檔案** (或私鑰)來存取你的錢包。請儲存並備份在額外的地方！如果沒有儲存你是沒有機會找回這個錢包的。 詳見[幫助頁面](https://www.airon.io/#help)來獲取更多資訊。 ',
...
HELP_Remind_Desc_1          : '**Ethereum, Airon.com & Airon CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**. ',
HELP_Remind_Desc_2          : 'Airon.com & Airon CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_0_Desc_1               : 'Airon gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_2b_Title               : '2b) How do I safely / offline / cold storage with Airon? ',
...
HELP_3_Desc_3               : 'Navigate to the Airon.com "View Wallet Info" page. ',
...
HELP_4CX_Title              : '4) How do I send Ether using Airon CX? ',
...
HELP_5_Title                : '5) How do I run Airon.com offline/locally? ',
HELP_5_Desc_1               : 'You can run Airon.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'Airon.com is now running entirely on your computer. ',
HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the Airon repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact. ',
HELP_5_Desc_9               : 'As we are constantly updating Airon.com, we recommend you periodically update your saved version of the repo. ',
...
HELP_8_Desc_1               : 'Airon is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain. ',
HELP_8_Desc_2               : 'If Airon.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of Airon because it\'s not in Airon. It\'s in whatever wallet your generated via our site. ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with Airon CX. That way if anything happens to Airon CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets. ',
HELP_8CX_Desc_3             : 'If for some reason Airon CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above. ',
...
HELP_12_Title               : '12) How do I import a wallet created with Airon into geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Using an Geth/Mist JSON file from Airon v2+.... ',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. Airon.com doesn\'t do this. Is the random number generation for Airon safe? ',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Airon.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Security - Airon CX ',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Airon.com instead of this Chrome Extension. ',
