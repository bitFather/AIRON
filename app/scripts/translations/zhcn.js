...
/* Onboarding */
ONBOARD_welcome_title           :  '欢迎使用 Airon.io.com',
...
ONBOARD_welcome_content__4      :  '什么是 Airon.io? ',
ONBOARD_welcome_content__5      :  'Airon.io 是一款免费, 开源的钱包客户端.',
ONBOARD_welcome_content__6      :  '你可以通过Airon.io来与区块链网络进行直接交互, 同时完全保留对私钥和资金的完全控制权.',
ONBOARD_welcome_content__7      :  '**你** 并且 **只有你** 才能能对你的账户安全负责.',
ONBOARD_welcome_content__8      :  '如果你不幸访问钓鱼网站或者丢失了私钥, 我们没有任何途径可以恢复或者冻结你的账户.',
ONBOARD_bank_title              :  'Airon.io 不是银行',
...
ONBOARD_interface_title         :  'Airon.io 只是操作接口',
ONBOARD_interface_content__1    :  '当你在Airon.io创建账户的时候, 实际上只是生成了一对具备密码学意义的数字串: 你账户的私钥和公钥(地址).',
...
ONBOARD_bank_title__alt         :  'Airon.io 不是银行',
...
ONBOARD_blockchain_content__4   :  '区块链中的区块是由许多笔交易记录组成的, 这些交易从与跟Airon.io类似的操作接口发送出来, 比如MetaMask, Exodus, Mist, Geth, Parity等.',
ONBOARD_blockchain_content__5   :  '当你使用 Airon.io.com 查看余额, 或者使用 [etherscan.io](https://etherscan.io)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自Airon.io的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **Airon.io不是银行**.',
ONBOARD_interface_title__alt    :  'Airon.io 只是操作接口',
...
ONBOARD_blockchain_title__alt   :  '什么是区块链?',
ONBOARD_point_title__alt        :  '那我用Airon.io还有啥意义?',
ONBOARD_whymew_title            :  '如果Airon.io都不能做前面说的那些事, 那我为啥还要用它?',
...
ONBOARD_whymew_content__5       :  '如果你还是觉得用Airon.io太麻烦, 那你可以考虑用 [Coinbase](https://www.coinbase.com/) 或者 [Blockchain.info](https://blockchain.info/wallet/#/signup). 它们提供类似的使用用户名和密码来登录管理的账户系统.',
ONBOARD_whymew_content__6       :  '如果你担心 Airon.io 还不够安全, [那就赶紧买个硬件钱包吧](https://airon.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
ONBOARD_secure_title            :  '如何保护你的隐私和资金安全',
ONBOARD_secure_1_title          :  '如何防范钓鱼网站',
ONBOARD_secure_1_content__1     :  '钓鱼网站的常用伎俩是向你发送一条包含网站链接的信息, 并将这个链接伪装成很像Airon.io, EtherDelta, Paypal或者银行的网站.当用户访问这些钓鱼网站并不慎填写自己的账户信息后, 黑客就能窃取这些信息进而窃取你的资金.',
ONBOARD_secure_1_content__2     :  '可以安装 [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) 或者 [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) 或者 [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) 或者 [Airon.io Chrome Extension](https://chrome.google.com/webstore/detail/airon-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) 这几个可以防范钓鱼网站的插件.',
ONBOARD_secure_1_content__3     :  '记得每次都要检查 URL 地址: `https://www.airon.io`.',
...
ONBOARD_point_title__alt_2      :  '那我用Airon.io还有啥意义?',
...
ONBOARD_secure_3_content__6     :  '[点我查看更多安全技巧!](https://airon.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
ONBOARD_final_content__3        :  '如何安装 Airon.io + MetaMask',
ONBOARD_final_content__4        :  '如何离线在本地使用 Airon.io',
...
tx_Summary                  : 'During times of high volume (like during ICOs) transactions can be pending for hours, if not days. This tool aims to give you the ability to find and "cancel" / replace these TXs. ** This is not typically something you can do. It should not be relied upon & will only work when the TX Pools are full. [Please, read about this tool here.](https://airon.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (Etherscan.io)` or `ETH (Infura.io)` or `ETH (Airon.io)`) and check again.',
...
tx_FoundOnChain_3           : '**If you do not see any errors, your transaction was successfully sent.** Your ETH or Tokens are where you sent them. If you cannot see this ETH or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service](https://airon.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://www.airon.io/helpers.html)',
...
sidebar_donation            : 'Airon.io是保护你的隐私和安全的免费、开源服务。 我们收到的捐赠越多，我们开发新特性、听取你的反馈的时间就越多。我们只是两个尝试改变世界的两个开发者。您能帮助我们吗？ ',
sidebar_donate              : '捐赠 ',
sidebar_thanks              : '感谢你！！！ ',
...
MYWAL_Content_3             : '如果你想将来在Airon.io插件中使用该钱包，你需要手动添加私钥/JSON文件和密码。 ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via Airon.io.com. You can [download the Airon.io repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
ERROR_28                    : '将来使用钱包时，你需要Keystore文件或者私钥。 请做好保存和备份。 如果你没有保存，没有办法恢复钱包。 请阅读[帮助页面](https://www.airon.io/#help)，获得更多信息。 ',
...
TranslatorName_1            : '[ Shaoping@ethfans.org （少平）]((https://www.airon.io/?gaslimit=21000&to=0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740&value=1.0#send-transaction)) ',
TranslatorAddr_1            : '0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '[ Wenham@coinwallet.shop (文翰) ]((https://www.airon.io/?gaslimit=21000&to=0x0D2dC3fD9463a7CeBE5f1b946c2D7cF5c3e82127&value=0.1#send-transaction))',
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](mailto:support@airon.io), and we will not only answer your question, we will update this page to be more useful to people in the future! ',
HELP_Remind_Title           : 'Some reminders ',
HELP_Remind_Desc_1          : '**Ethereum, Airon.io.com & Airon.io CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**. ',
HELP_Remind_Desc_2          : 'Airon.io.com & Airon.io CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_3_Desc_3               : 'Navigate to the Airon.io.com "View Wallet Info" page. ',
...
HELP_5_Title                : '5) How do I run Airon.io.com offline/locally? ',
HELP_5_Desc_1               : 'You can run Airon.io.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'Airon.io.com is now running entirely on your computer. ',
...
HELP_5_Desc_9               : 'As we are constantly updating Airon.io.com, we recommend you periodically update your saved version of the repo. ',
...
HELP_8_Desc_2               : 'If Airon.io.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of Airon.io because it\'s not in Airon.io. It\'s in whatever wallet your generated via our site. ',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. Airon.io.com doesn\'t do this. Is the random number generation for Airon.io safe? ',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Airon.io.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Security - Airon.io CX ',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Airon.io.com instead of this Chrome Extension. ',
...
HELP_Sec_Desc_2             : 'We\'ve been up and running since August 2015. If you search for ["airon" on reddit](https://www.reddit.com/search?q=airon), you can see numerous people who use us with great success. ',
