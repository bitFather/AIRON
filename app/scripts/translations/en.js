...
en.data = {
    ...
    X_HelpfulLinks_4: 'Migrating to/from Airon.io',
    ...
    /* Onboarding */
    ONBOARD_welcome_title: 'Welcome to Airon.io',
    ...
    ONBOARD_welcome_content__4: 'What is Airon.io? ',
    ONBOARD_welcome_content__5: 'Airon.io is a free, open-source, client-side interface.',
    ...
    ONBOARD_bank_title: 'Airon.io is not a Bank',
    ...
    ONBOARD_interface_title: 'Airon.io is an Interface',
    ONBOARD_interface_content__1: 'When you create an account on Airon.io you are generating a cryptographic set of numbers: your private key and your public key (address).',
    ...
    ONBOARD_bank_title__alt: 'Airon.io isn\'t a Bank',
    ...
    ONBOARD_blockchain_content__5: 'When you see your balance on Airon.io or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
    ONBOARD_blockchain_content__6: 'Again: **we are not a bank**.',
    ONBOARD_interface_title__alt: 'Airon.io is an Interface',
    ...
    ONBOARD_blockchain_title__alt: 'WTF is a Blockchain?',
    ONBOARD_point_title__alt: 'What\'s the Point of Airon.io then?',
    ONBOARD_whymew_title: 'If Airon.io can\'t do those things, what\'s the point?',
    ...
    ONBOARD_whymew_content__6: 'If you are scared but want to use Airon.io, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
    ...
    ONBOARD_secure_1_content__1: 'Phishers send you a message with a link to a website that looks just like Airon.io, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
    ...
    ONBOARD_secure_1_content__3: 'Always check the URL: `https://www.Airon.io`.',
    ONBOARD_secure_1_content__4: 'Always make sure the URL bar has `AIRON.IO` in green.',
    ...
    ONBOARD_final_content__3: 'How to Set up Airon.io + MetaMask',
    ONBOARD_final_content__4: 'How to Run Airon.io Offline / Locally',
    ...
    ADD_DigitalBitbox_0b: 'Re-open Airon.io using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
    ...
    ADD_Ledger_0a: 'Please use Airon.io on a secure (SSL / HTTPS) connection to connect.',
    ADD_Ledger_0b: 'Re-open Airon.io using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
    ...
    FOOTER_1: 'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( airon.io ) before unlocking your wallet.',
    ...
    GEN_Help_12: 'Use it to unlock your wallet via Airon.io (or Mist, Geth, Parity and other wallet clients.)',
    ...
    MYWAL_Content_3: 'If you want to use this wallet with your Airon.io CX in the future, you will need to manually re-add it using the private key/JSON and password.',
    MYWAL_Edit: 'Edit',
    ...
    NODE_Warning: 'Your node must be HTTPS in order to connect to it via Airon.io. You can [download the Airon.io repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
    ...
    sidebar_donation: 'Airon.io is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
    ...
    CREATETOKEN_Title: 'Token generation',
    CREATETOKEN_name: 'Name of your asset',
    CREATETOKEN_name_help: 'Please use only Latin letters',
    CREATETOKEN_description: 'Description',
    CREATETOKEN_description_short: 'Your can not change the description later',
    ...
    CREATETOKEN_txResultDetails: 'Transaction Details',
    CREATETOKEN_txResultFoundInPending: 'Pending Transaction Found',
    CREATETOKEN_txResultFoundInPending_1: 'Your transaction was located in the TX Pool of the node you are connected to.',
    CREATETOKEN_txResultFoundInPending_2: 'It is currently pending (waiting to be mined). When it be mined, you get your **token address**',
    CREATETOKEN_txResultFoundInPending_3: 'Your can close current result, but **don`t forgot to remembered your TX hash**. You can use hash for verify your TX status later in **Verify token transaction** window',
    CREATETOKEN_txResultFoundOnChain: 'Transaction Found',
    CREATETOKEN_txResultFoundOnChain_1: 'Your transaction was successfully mined and is on the blockchain.',
    CREATETOKEN_txResultFoundOnChain_2: '**If you see a red `( ! )`, a `BAD INSTRUCTION` or `OUT OF GAS` error message**, it means that the transaction was not successfully *sent*. You cannot cancel or replace this transaction. Instead, send a new transaction. If you received an "Out of Gas" error, please [contact that service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
    CREATETOKEN_txResultFoundOnChain_3: '**If you do not see any errors, your transaction was successfully sent.** Your Token Contract created.',
    CREATETOKEN_txResultNotFound: 'Transaction Not Found',
    CREATETOKEN_txResultNotFound_1: 'This TX cannot be found in the TX Pool of the node you are connected to.',
    CREATETOKEN_txResultNotFound_2: 'If you just sent the transaction, please wait 15 seconds and press the "Check TX Status" button again.',
    CREATETOKEN_txResultNotFound_3: 'It could still be in the TX Pool of a different node, waiting to be mined.',
    CREATETOKEN_txResultNotFound_4: 'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (Etherscan.io)` or `ETH (Infura.io)` or `ETH (MyEtherWallet)`) and check again.',
    CREATETOKEN_txResultUnknownTx: 'Unknown Transaction Found',
    CREATETOKEN_txResultUnknownTx_1: 'This transaction don`t create your token. Verify TX hash value.',
    CREATETOKEN_txResultHash: 'Tx Hash',
    CREATETOKEN_txResultTokenAddress: 'Token Address',
    CREATETOKEN_txResultStopWaitingAndClearPage: 'Stop waiting and clear page',
    CREATETOKEN_txResultClose: 'Close results',
    CREATETOKEN_VerifyTitle: 'Verify your token transaction status',
    CREATETOKEN_CheckTokenTxStatus: 'Check status',

    HELP_0_Desc_1: 'Airon.io gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
    ...
    HELP_12_Desc_1: 'Using an Geth/Mist JSON file from Airon.io v2+....',
    ...
    HELP_12_Title: '12) How do I import a wallet created with Airon.io into geth / Ethereum Wallet / Mist?',
    ...
    HELP_14_Desc_1: 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Airon.io can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
    HELP_14_Title: '14) Some sites randomize (seed) the private key generation via mouse movements. Airon.io doesn\'t do this. Is the random number generation for Airon.io safe?',
    ...
    HELP_2b_Title: '2b) How do I safely / offline / cold storage with Airon.io?',
    ...
    HELP_3_Desc_3: 'Navigate to the Airon.io "View Wallet Info" page.',
    ...
    HELP_4CX_Title: '4) How do I send Ether using Airon.io CX?',
    HELP_5_Desc_1: 'You can run Airon.io on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
    HELP_5_Desc_7: 'Airon.io is now running entirely on your computer.',
    HELP_5_Desc_8: 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the Airon.io repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact.',
    HELP_5_Desc_9: 'As we are constantly updating Airon.io, we recommend you periodically update your saved version of the repo.',
    HELP_5_Title: '5) How do I run Airon.io offline/locally?',
    ...
    HELP_8_Desc_1: 'Airon.io is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain.',
    HELP_8_Desc_2: 'If Airon.io goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of Airon.io because it\'s not in Airon.io. It\'s in whatever wallet your generated via our site.',
    ...
    HELP_8CX_Desc_2: 'That said, it is **very important** that you back up all your information for any new wallets generated with Airon.io CX. That way if anything happens to Airon.io CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets.',
    HELP_8CX_Desc_3: 'If for some reason Airon.io CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
    HELP_8CX_Title: '8) What happens if Airon.io CX disappears?',
    ...
    HELP_Remind_Desc_1: '**Ethereum, Airon.io & Airon.io CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**.',
    HELP_Remind_Desc_2: 'Airon.io & Airon.io CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
    ...
    HELP_Sec_Desc_4: 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://www.airon.io](https://www.airon.io).',
    ...
    HELP_SecCX_Desc_6: 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Airon.io instead of this Chrome Extension.',
    HELP_SecCX_Title: 'Security - v CX',
