...
en.data = {
    ...
    /* Old */
    ADD_DigitalBitbox_0a: 'Re-open AironWallet on a secure (SSL) connection',
    ADD_DigitalBitbox_0b: 'Re-open AironWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
    ...
    ADD_Ledger_0a: 'Please use AironWallet on a secure (SSL / HTTPS) connection to connect.',
    ADD_Ledger_0b: 'Re-open AironWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
    ...
    FOOTER_1: 'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( aironwallet.com ) before unlocking your wallet.',
    ...
    MYWAL_Content_3: 'If you want to use this wallet with your AironWallet CX in the future, you will need to manually re-add it using the private key/JSON and password.',
    MYWAL_Edit: 'Edit',
    ...
    NODE_Warning: 'Your node must be HTTPS in order to connect to it via AironWallet.com. You can [download the AironWallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
    ...
    sidebar_donation: 'AironWallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
