...
ru.data = {
    ...
    X_HelpfulLinks_4                :  'Migrating to/from AironWallet',
    ...
    /* Onboarding */
    ONBOARD_welcome_title           :  'Welcome to AironWallet.com',
    ...
    ONBOARD_welcome_content__4      :  'What is AW? ',
    ONBOARD_welcome_content__5      :  'AironWallet is a free, open-source, client-side interface.',
    ...
    ONBOARD_bank_title              :  'AironWallet is not a Bank',
    ...
    ONBOARD_interface_title         :  'AironWallet is an Interface',
    ONBOARD_interface_content__1    :  'When you create an account on AironWallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
    ...
    ONBOARD_bank_title__alt         :  'AW isn\'t a Bank',
    ...
    ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from AironWallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
    ONBOARD_blockchain_content__5   :  'When you see your balance on AironWallet.com or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
    ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
    ONBOARD_interface_title__alt    :  'AW is an Interface',
    ...
    ONBOARD_blockchain_title__alt   :  'WTF is a Blockchain?',
    ONBOARD_point_title__alt        :  'What\'s the Point of AW then?',
    ONBOARD_whymew_title            :  'If AironWallet can\'t do those things, what\'s the point?',
    ...
    ONBOARD_whymew_content__6       :  'If you are scared but want to use AW, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
    ...
    ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like AironWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
    ...
    ONBOARD_secure_1_content__3     :  'Always check the URL: `https://www.aironwallet.com`.',
    ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `AIRONWALLET LLC [US]` in green.',
    ...
    ONBOARD_final_content__3        :  'How to Set up AW + MetaMask',
    ONBOARD_final_content__4        :  'How to Run AW Offline / Locally',
    ...
    GEN_Help_12                 : 'Use it to unlock your wallet via AironWallet (or Mist, Geth, Parity and other wallet clients.) ',
    ...
    NAV_TokenCreation           : 'Создать токен',
    ...
    CREATETOKEN_Title: 'Генерация токена',
    CREATETOKEN_name: 'Название вашего актива',
    CREATETOKEN_name_help: 'Пожалуйста, используйте только Латинские буквы',
    CREATETOKEN_description: 'Описание',
    CREATETOKEN_description_short: 'Вы не сможете изменить описание позже',
    CREATETOKEN_totalTokens: 'Общее количество токенов',
    CREATETOKEN_decimals: 'Знаков после запятой',
    ...
    MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в AironWallet CX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',
    ...
    NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы AironWallet.com мог с ним работать. Вы можете [скачать репозиторий AironWallet & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
    NODE_Name                   : 'Имя узла',
    NODE_Port                   : 'Порт узла',
    ...
    ADD_Ledger_0a               : 'Перезапустите AironWallet через безопасное (SSL) соединение ',
    ADD_Ledger_0b               : 'Перезапустите AironWallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
    ...
    ADD_DigitalBitbox_0a        : 'Перезапустите AironWallet через безопасное (SSL) соединение ',
    ADD_DigitalBitbox_0b        : 'Перезапустите AironWallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
    ...
    ERROR_36                    : 'Введите корректный хеш транзакции', // 36
    ERROR_37                    : 'Enter valid hex string (0-9, a-f)', // 37
    ERROR_40                    : 'Ошибка расчета комиссии. Попробуйте сменить сеть.',
    ERROR_41                    : 'Название актива должно содержать 3-4 Латинские буквы.',
    ERROR_42                    : 'Общее количество токенов не определено.',
    ERROR_43                    : 'Количество знаков после запятой варьируется от 0 до 18.',
    ...
    HELP_Remind_Desc_1          : '**Ethereum, AironWallet.com & AironWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**. ',
    HELP_Remind_Desc_2          : 'AironWallet.com & AironWallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
    ...
    HELP_0_Desc_1               : 'AironWallet gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
    ...
    HELP_2b_Title               : '2b) How do I safely / offline / cold storage with AironWallet? ',
    ...
    HELP_3_Desc_3               : 'Navigate to the AironWallet.com "View Wallet Info" page. ',
    ...
    HELP_4CX_Title              : '4) How do I send Ether using AironWallet CX? ',
    ...
    HELP_5_Title                : '5) How do I run AironWallet.com offline/locally? ',
    HELP_5_Desc_1               : 'You can run AironWallet.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
    HELP_5_Desc_7               : 'AironWallet.com is now running entirely on your computer. ',
    HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the AironWallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact. ',
    HELP_5_Desc_9               : 'As we are constantly updating AironWallet.com, we recommend you periodically update your saved version of the repo. ',
    ...
    HELP_8_Desc_1               : 'AironWallet is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain. ',
    HELP_8_Desc_2               : 'If AironWallet.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of AironWallet because it\'s not in AironWallet. It\'s in whatever wallet your generated via our site. ',
    ...
    HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with AironWallet CX. That way if anything happens to AironWallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets. ',
    HELP_8CX_Desc_3             : 'If for some reason AironWallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above. ',
    ...
    HELP_12_Title               : '12) How do I import a wallet created with AironWallet into geth / Ethereum Wallet / Mist? ',
    HELP_12_Desc_1              : 'Using an Geth/Mist JSON file from AironWallet v2+.... ',
    ...
    HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. AironWallet.com doesn\'t do this. Is the random number generation for AironWallet safe? ',
    HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, AironWallet.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
    ...
    HELP_SecCX_Title            : 'Security - AironWallet CX ',
    ...
    HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use AironWallet.com instead of this Chrome Extension. ',
    ...
    HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://www.aironwallet.com](https://www.aironwallet.com). ',
