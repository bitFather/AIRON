...
contract DetailedERC20 is ERC20 {
    ...
    function userTransfer(address _to, uint256 _value) onlyPayloadSize(64) external returns (bool success) {
    ...
    function userTransferFrom(address _from, address _to, uint256 _value) onlyPayloadSize(64) external returns (bool success) {
    ...
    function userApprove(address _spender, uint256 _old, uint256 _new) onlyPayloadSize(64) external returns (bool success) {
