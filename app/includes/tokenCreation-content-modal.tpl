<article class="modal fade" id="deployToken" tabindex="-1">
    <section class="modal-dialog">
        <section class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p translate="CREATETOKEN_Warning_2">
                    You are about to <strong>generate token</strong>.
                </p>
                <p>
          <span translate="CREATETOKEN_Warning_3">
